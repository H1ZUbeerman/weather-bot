...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Прогнозы:\n"
        "/weather — погода сейчас для твоего home\n"
        "/weather Москва — погода для любого города\n"
        ...
        "/set_home — выбрать домашнюю локацию\n"
        "/set_home moscow_ilya — пример выбора home\n\n"

        "Персонализация:\n"
        "/profile — профиль рекомендаций\n"
        "/profile cold — я мерзну\n"
        "/profile car — я на машине\n"
        "/profile rain — важны дожди\n"
        "/profile camping — палатка\n"
        "/profile kayak — байдарка\n\n"
        ...
        "/learning_locations — список локаций обучения\n"
        "/learning_now — сохранить прогноз сейчас\n"
        "/learning_verify_now — проверить прогнозы сейчас\n"
